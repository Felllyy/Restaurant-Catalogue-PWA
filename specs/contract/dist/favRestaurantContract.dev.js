...
var itActsAsFavoriteRestaurantModel = function itActsAsFavoriteRestaurantModel(FavoriteRestaurant) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.t0 = expect;
            _context.next = 5;
            return regeneratorRuntime.awrap(FavoriteRestaurant.getRestaurant(1));
          ...
          case 5:
            ...
            _context.t3 = expect;
            _context.next = 11;
            return regeneratorRuntime.awrap(FavoriteRestaurant.getRestaurant(2));
          ...
          case 11:
            ...
            _context.t6 = expect;
            _context.next = 17;
            return regeneratorRuntime.awrap(FavoriteRestaurant.getRestaurant(3));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.t0 = expect;
            _context2.next = 4;
            return regeneratorRuntime.awrap(FavoriteRestaurant.getAllRestaurants());
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 5;
            return regeneratorRuntime.awrap(FavoriteRestaurant.deleteRestaurant(1));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 5;
            return regeneratorRuntime.awrap(FavoriteRestaurant.deleteRestaurant(4));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.t0 = expect;
            _context6.next = 7;
            return regeneratorRuntime.awrap(favoriteRestaurant.searchRestaurants('restaurant a'));
