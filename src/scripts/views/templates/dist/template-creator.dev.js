...
const createRestaurantsReviewTemplate = function createRestaurantsReviewTemplate(restaurant) {
...
const createLikeButtonTemplate = function createLikeButtonTemplate() {
  return '\n  <button aria-label="like this movie" id="likeButton" class="like">\n     <i class="fa fa-heart-o" aria-hidden="true"></i>\n  </button>\n';
};

exports.createLikeButtonTemplate = createLikeButtonTemplate;

const createLikedButtonTemplate = function createLikedButtonTemplate() {
